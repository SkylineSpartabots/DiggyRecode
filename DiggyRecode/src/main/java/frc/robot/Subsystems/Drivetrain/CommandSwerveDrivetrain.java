...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public static CommandSwerveDrivetrain getInstance(){
        if(s_Swerve == null){
            s_Swerve = new CommandSwerveDrivetrain(TunerConstants.DrivetrainConstants,
             50, // Hardcode to 50 Hz to guarantee lower CAN bus utilization
             odo_sdv,
             vis_sdv,
    ...
    public void periodic() {
        ...
        // Raw values are automatically logged to .hoot files by Phoenix 6.
        // Putting high-frequency raw values to NetworkTables burns RIO CPU without benefit.
        // SignalLogger.writeDoubleArray("Odometry", new double[]{ s_Swerve.getState().Pose.getX(), s_Swerve.getState().Pose.getY(), s_Swerve.getState().Pose.getRotation().getDegrees() });
    }
